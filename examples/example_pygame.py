...
def main():
    ...
    while running:
        ...
        with cui.CoshUIRenderer(cui.PygameBackend(screen), cui.DEBUG):
            with cui.Container(id="root", width=500, height=500, classes="label_color", padding=(10, 10, 10, 0)):
                cui.Container(id="child", width=cui.FILL, height=cui.FILL, style=cui.CoshStyling(background_color=(255, 100, 100)))
        #     cui.RichLabel(id="first_rich", text="[red font=Ubuntu bold italic strikethrough underline]Hello[/][color=(255, 100, 255)] World! My name is JyleFV and I really[/] like Minecraft!", text_color=(0, 0, 0), text_align=cui.TEXT_ALIGN_TOP, text_justify=cui.TEXT_JUSTIFY_LEFT, width=200, height=500, text_overflow=cui.TEXT_WRAP, style=cui.CoshStyling(background_color=(255, 255, 255)))
